...
[assign var="editurl"][url controller="blog" action="view" category="[c]category.slug[/c]" edit="true" /][/assign]
[transform function="base"]
    ...
    <h1>[c]category.title[/c][if condition="user.admin"] (<a href="[c]editurl[/c]">[gettext]edit[/gettext]</a>)[/if]</h1>
    [/if]
